                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <div>
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="../assets/images/logo-icon-upsi.png" alt="homepage" class="dark-logo" style="width: 30%;"/>
                                <!-- Light Logo icon -->
                                <img src="../assets/images/logo-icon-upsi.png" alt="homepage" class="light-logo"style="width: 30%;"/>
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="../assets/images/KolejKu-text.png" alt="homepage" class="dark-logo" />
                                <!-- Light Logo text -->
