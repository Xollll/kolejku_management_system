<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = "INSERT INTO booking (roomno, seater, feespm, foodstatus, stayfrom, duration, regno, firstName, lastName, gender, contactno, emailid, egycontactno, guardianName, guardianRelation, guardianContactno, corresAddress, corresCity, corresPincode, pmntAddress, pmntCity, pmntPincode) 
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
