<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $query = "INSERT INTO userregistration (regNo, firstName, lastName, gender, contactNo, email, password) 
                VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        // Bind parameters
        if ($stmt) {
            $stmt->bind_param('ssssiss', $regno, $fname, $lname, $gender, $contactno, $emailid, $password);
            $stmt->execute();
