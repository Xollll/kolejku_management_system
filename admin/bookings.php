<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = "INSERT into booking (roomno, seater, feespm, foodstatus, stayfrom, duration, regno, firstName, lastName, gender, contactno, emailid, egycontactno, guardianName, guardianRelation, guardianContactno, corresAddress, corresCIty, corresPincode, pmntAddress, pmntCity, pmntPincode) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        
        $stmt = $mysqli->prepare($query);
        $rc = $stmt->bind_param('iiiisissssisissississi', $roomno, $seater, $feespm, $foodstatus, $stayfrom, $duration, $regno, $fname, $lname, $gender, $contactno, $emailid, $emcntno, $gurname, $gurrelation, $gurcntno, $caddress, $ccity, $cpincode, $paddress, $pcity, $ppincode);
...
<head>
    ...
    <title>KolejKu Management System</title>
    <!-- Custom CSS -->
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="customRadio1">Required <code>Extra RM 211 Per Month</code></label>
                                </div>
                                <div class="custom-control custom-radio">
